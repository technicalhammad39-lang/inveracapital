...
export function AdminTopNav() {
  ...
  const navLinks = [
    ...
    { name: 'Support', href: '/yesadmin786/support', icon: LifeBuoy },
    { name: 'Content', href: '/yesadmin786/content', icon: FileText },
    { name: 'Finance', href: '/yesadmin786/finance', icon: DollarSign },
    { name: 'Security', href: '/yesadmin786/security', icon: Lock },
    { name: 'Settings', href: '/yesadmin786/settings', icon: Settings },
  ];
        ...
        <div className="relative" ref={profileRef}>
          ...
          >
            <div className="text-right hidden sm:block">
              <div className="text-xs font-semibold text-text-primary">System Administrator</div>
              <div className="text-[9px] text-brand tracking-widest uppercase font-bold mt-0.5">Super Admin</div>
            </div>
            ...
            {profileOpen && (
              ...
              >
                ...
                <div className="p-3 border-b border-border/60 mb-1">
                  <p className="text-xs font-bold text-text-primary">System Administrator</p>
