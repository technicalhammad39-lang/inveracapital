...
export default function RolesPlaceholder() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center">
      ...
      <h1 className="text-3xl font-bold text-white mb-4">Role Management & Permissions</h1>
      <p className="text-text-secondary max-w-md mx-auto">
        This module is currently under active development. Enterprise access control and permissions routing will be available here soon.
      </p>
    </div>
  );
}
